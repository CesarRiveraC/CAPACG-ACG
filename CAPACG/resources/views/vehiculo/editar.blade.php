                ...
                <div class="panel-body">
                    ...
                    <input type="hidden" name="_method" value="PUT">
                        ...
                        <div class="form-group{{ $errors->has('PlacaVehiculo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="PlacaVehiculo" type="text" class="form-control" name="PlacaVehiculo" value="{{ $vehiculo->PlacaVehiculo}}" required autofocus>    
                                @if ($errors->has('PlacaVehiculo'))
                        ...
                        <div class="form-group{{ $errors->has('Placa') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('Descripcion') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="Descripcion" type="text" class="form-control" name="Descripcion" value="{{ $vehiculo->inmueble->activo->Descripcion }}" required autofocus>                               
                    ...
                    @if ($errors->has('TipoActivo'))
                        ...
                        <div class="form-group{{ $errors->has('Programa') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="Programa" type="text" class="form-control" name="Programa" value="{{ $vehiculo->inmueble->activo->Programa }}" required>                               
                        ...
                        <div class="form-group{{ $errors->has('SubPrograma') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="SubPrograma" type="text" class="form-control" name="SubPrograma" value="{{ $vehiculo->inmueble->activo->SubPrograma }}" required>                               
                        ...
                        <div class="form-group{{ $errors->has('Color') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="Color" type="text" class="form-control" name="Color" value="{{$vehiculo->inmueble->activo->Color}}" required>                               
                        ...
                        <div class="form-group{{ $errors->has('Serie') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="Serie" type="text" class="form-control" name="Serie" value="{{$vehiculo->inmueble->Serie}}" required autofocus>    
                                @if ($errors->has('Serie'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('Marca') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="Marca" type="text" class="form-control" name="Marca" value="{{$vehiculo->inmueble->Marca }}" required autofocus>                               
                        ...
                        <div class="form-group{{ $errors->has('Modelo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="Modelo" type="text" class="form-control" name="Modelo" value="{{ $vehiculo->inmueble->Modelo }}" required autofocus>                               
                        ...
                        <div class="form-group{{ $errors->has('EstadoUtilizacion') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="EstadoUtilizacion" type="text" class="form-control" name="EstadoUtilizacion" value="{{ $vehiculo->inmueble->EstadoUtilizacion }}" required>                               
                        ...
                        <div class="form-group{{ $errors->has('EstadoFisico') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="EstadoFisico" type="text" class="form-control" name="EstadoFisico" value="{{ $vehiculo->inmueble->EstadoFisico }}" required>
                        ...
                        <div class="form-group{{ $errors->has('EstadoActivo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="EstadoActivo" type="text" class="form-control" name="EstadoActivo" value="{{ $vehiculo->inmueble->EstadoActivo }}" required>

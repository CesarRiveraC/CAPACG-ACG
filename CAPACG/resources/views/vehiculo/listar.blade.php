								...
								<tr>
									...
									<td class="warning">
										...
										<a href="/vehiculos/{{$vehiculo->id}}/edit" class="btn btn-warning btn-xs fa fa-pencil" data-toggle="tooltip" data-placement="bottom"
										 title="Editar"></a>
										<a class="btn btn-info btn-xs fa fa-child asignarColaborador" style="display:none" data-vehiculo="{{$vehiculo->id}}" data-toggle="tooltip"
...
@include('modals.estado') @include('modals.detalleVehiculo') @include('modals.modalPrueba') 
@include('modals.filtrar') @include('modals.filtrarDependencia') @include('modals.filtrarTipo')
@include('modals.filtrarFecha') @include('modals.filtrarSector') @include('modals.asignarColaborador')

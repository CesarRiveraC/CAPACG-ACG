                ...
                <div class="panel-body">
                    ...
                    <input type="hidden" name="_method" value="PUT">
                        ...
                        <div class="form-group{{ $errors->has('Placa') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="Placa" type="text" class="form-control" name="Placa" value="{{ $semoviente->activo->Placa }}" required autofocus>    
                         ...
                         <div class="form-group{{ $errors->has('Descripcion') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="Descripcion" type="text" class="form-control" name="Descripcion" value="{{ $semoviente->activo->Descripcion }}" required autofocus>                               
                        ...
                        <option value="{{ $semoviente->activo->tipo_id }}">{{$tipos->Tipo}}</option
                        ...
                        <div class="form-group{{ $errors->has('Programa') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="Programa" type="text" class="form-control" name="Programa" value="{{ $semoviente->activo->Programa }}" required>                               
                        ...
                        <div class="form-group{{ $errors->has('SubPrograma') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="SubPrograma" type="text" class="form-control" name="SubPrograma" value="{{ $semoviente->activo->SubPrograma }}" required>                               
                        ...
                        <div class="form-group{{ $errors->has('Color') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="Color" type="text" class="form-control" name="Color" value="{{$semoviente->activo->Color}}" required>                               

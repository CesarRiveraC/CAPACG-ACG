...
<div class="container">
    ...
    <div class="row">
    <div id="homeContent" class="col-md-10 col-md-offset-1">
    <div class="jumbotron">
    ...
    <div id="homeContent" class="col-md-4">
          ...
          <h2 id="titulo">Infraestructuras</h2>
        ...
        <div id="homeContent" class="col-md-4">
          ...
          <h2 id="titulo">Combustibles</h2>
          <p class="text-justify" id="texto">En este modulo se puede administrar todas las facturas de combustibles hechas a un vehiculo.
          <br>
        ...
        <div id="homeContent" class="col-md-4">
          ...
          <p class="text-justify" id="texto">En este modulo se puede administrar los usuarios pertenecientes al sistema.
          <br>

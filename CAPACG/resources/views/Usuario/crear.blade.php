                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="/usuarios">
                        ...
                        <div class="form-group{{ $errors->has('PuestoDeTrabajo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="PuestoDeTrabajo" type="text" class="form-control" name="PuestoDeTrabajo" value="{{ old('PuestoDeTrabajo') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('LugarDeTrabajo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="LugarDeTrabajo" type="text" class="form-control" name="LugarDeTrabajo" required>
